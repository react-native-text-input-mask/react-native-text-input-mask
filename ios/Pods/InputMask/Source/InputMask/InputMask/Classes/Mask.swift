 ...
 */
open class Mask: CustomDebugStringConvertible, CustomStringConvertible {
    ...
    fileprivate static var cache: [String : Mask] = [:]
     ...
     */
    open static func getOrCreate(withFormat format: String) throws -> Mask {
     ...
     */
    open func apply(toText text: CaretString, autocomplete: Bool = false) -> Result {
